    ...
    <div class="col-md-12">
        <div class="box box-solid">
            <div class="box-header ">
                  <h3 class="box-title"><strong>Editar UFM</strong></h3>
                  <button class='btn btn-primary btn-xs'>Voltar</button>
            </div>
            <div class="box-body">
                <div class="panel box box-primary"> 
                    ...
                    <div class="container col-md-12">
                        ...
                        <form action="<?php echo base_url('/Ufms/edit_ufm/'.$id_ufm)?>" method='POST' class='form_diaria col-sm-12'>                                       
                            <?php if($msg != '') :?>
                            ...
                            <div class='col-sm-6 form-group'>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class='form-control' type="text" name="servidor" value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['servidor'] : ''?>" required>
                                </div>

                                <div class='form-group'>
                                    <label for="matricula">Matricula do Servidor: </label>
                                    <input class='form-control' type="text" name='matricula' value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['portaria_matricula']: ''?>">
                                </div>
                                
                                <div class="form-group">                
                                    <label for="servidor">Banco: </label><br>
                                    <input class='form-control' type="text" name="banco" value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['banco']: ''?>" required>
                                </div>

                                <div class="form-group">  
                                    <label for="servidor">Agência: </label><br>
                                    <input class='form-control' type="text" name="agencia" value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['agencia']: ''?>"required>
                                </div>

                                <div class="form-group">  
                                    <label for="servidor">Conta: </label><br>
                                    <input class='form-control' type="text" name="conta" value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['conta']: ''?>" required>
                                </div>
                            ...
                            <div class='col-sm-6 form-group'>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="telefone"  data-inputmask='"mask": "(99) 9 9999-9999"' data-mask  value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['telefone'] : ''?>" required>
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <label for="servidor">Valor Atual UFM: </label><br>
                                    <input class='form-control' type="number" step='0.01' name="valor_ufm" value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['valor_ufm']: ''?>" required>
                                </div>
                                
                                <div class="form-group">
                                    <label for="servidor">CPF do servidor: </label><br>
                                    <input class='form-control' type="text" name="cpf"  id='CPF' value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['cpf']: ''?>" required>
                                </div>

                                <div class="form-group">
                                    <label for="servidor">Cargo do servidor: </label><br>
                                    <input class='form-control' type="text" name="cargo" value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['cargo']: ''?>" required>
                                </div>
                                
                                <div class="form-group">  
                                    <label for="servidor">Motivo da Diária: </label><br>
                                    <input class='form-control' type="text" name="motivo" value="<?php echo isset($dados_ufm[0]) ? $dados_ufm[0]['motivo']: ''?>"required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- <span id='campovazio2' class='label label-danger col-sm-12 text-left' style='color:red; display:none'>Favor Informar o Veículo</span> -->
                                </div>
