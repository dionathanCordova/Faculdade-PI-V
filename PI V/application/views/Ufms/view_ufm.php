            ...
            <div class="box-header">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="btn-group pull-right col-sm-2" role="group" >
                        ...
                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
                                <a href="<?php echo base_url('Ufms/ufms')?>">
                    ...
                    <div class="btn-group pull-right" role="group" >
                        ...
                        <ul class="dropdown-menu">
                            <a href="<?php echo base_url('Ufms/ufm/1')?>">
                                <button type='submit' class='btn btn-default col-sm-12' name='btn_id' value="<?php echo $id_diaria;?>"><i class="glyphicon glyphicon-home"></i> Voltar</button></a>
                            </a> 
                            <?php if($user_confirm_diaria == '1'):?>
                                <a href="<?php echo base_url('Ufms/Pdfufm/').$id_diaria?>" target='_blank'>
                                ...
                                <a href="<?php echo base_url('Ufms/Pdfrelatorioufm/').$id_diaria?>" target='_blank'>
                            ...
                            <?php if($user_confirm_diaria != '1'):?>
                                <?php if($confirmacao == '0'):?>                           
                                    ...
                                    <a href="<?php echo base_url('Ufms/edit_ufm/').$id_diaria?>">
                        ...
                        <div class="informacoes_gerais col-xs-12 text-center" style='margin-top:2vmin;'>
                            <div  style='border: 1px solid black' class=' text-left'>
                                <table id="infoGeral" class='table table-condensed'>
                                    ...
                                    <tr>
                                        <td class='col-xs-6'><strong> Nº de Ufms: <?= $dados_diaria[0]['ufm']?></strong></td>
                                        <td> </td>
                                    </tr>
                                    <tr>
                                        <td class='col-xs-6'><strong> Valor Unitário: R$ <?=  number_format($dados_diaria[0]['valor_ufm'],'2', ',','')?></strong></td>
                                        <td> </td>
                                    </tr>
                                    <tr>
