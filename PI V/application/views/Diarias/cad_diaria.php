                    ...
                    <div class="container col-md-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#home">Registrar Diária <span class='text-success'>(Servidores cadastrados)</span></a></li>
                                <li><a data-toggle="tab" href="#menu1">Registrar Díaria  <span class='text-warning'>(Servidores sem cadastrados)</span> </a></li>
                            </ul>

                            <div class="tab-content container-fluid">   
                                <div id="home" class="tab-pane fade in active col-sm-12">   
                                    <form action="<?php echo base_url('Diarias/cadDiariaServidorCadastrado');?>" method="POST" class='form_diaria col-sm-12'>                                        
                                        <?php if($msg != '') :?>
                                        ...
                                        <div class='col-sm-6 form-group'>                                              
                                            ...
                                            <div class="form-group">  
                                                ...
                                                <input class='form-control' type="text" name="motivo" id='motivo' value="<?php echo isset($postinmemoria) ? $postinmemoria['motivo'] : ''?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class='col-sm-6 form-group'>
                                            <div class="form-group">
                                                ...
                                                <input type="radio" id='cargo-motorista' name='Cadastrar' style='margin-left:2vmin' checked> <label for="Cadastrar"> Informar</label>
                                                ...
                                                <p class='cargo-outros' style='display:none'>
                                                    <input class='form-control' type="text" name='veiculo' disabled id="veiculo" placeholder='Servidor com veiculo vinculado em seu cadastro'>
                                                </p>
                                            </div>	
                                        ...
                                        <div id='campovazio' class="form-group col-sm-12" style='color:red; display:none'>
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    <form action="<?php echo base_url('Diarias/cad_diarias');?>" method="POST" class='form_diaria col-sm-12'>                                        
                                        <?php if($msg != '') :?>
                                        <div class="form-group col-sm-12">
                                            <div class="alert alert-danger alert-dismissible col-sm-12">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                        ...
                                        <div class='col-sm-6 form-group'>
                                            <div class='form-group'>
                                                ...
                                                <input class='form-control' type="number" name='matricula'  id='matricula' value="<?php echo isset($postinmemoria) ? $postinmemoria['portaria_matricula'] : ''?>"required>
                                            </div>
                                            ...
                                            <div class='form-group'>
                                                <label for="estado_destino">Estado Destino</label>
                                                <select class='form-control data_saida' name="estado_destino" id="estado_destino2" required   value="<?php echo isset($postinmemoria) ? $postinmemoria['estado_destino'] : ''?>">
                                                    <?php echo $estado?>
                                                </select>
                                            </div>
                                            ...
                                            <div class='form-group'>
                                                <label for="cidade_destino">Selecione a cidades</label>
                                                <select class='form-control cidade_destino' name="cidade_destino" id="cidade_destino2"  value="<?php echo isset($postinmemoria) ? $postinmemoria['cidade_destino'] : ''?>">
                                                    <option value="">Selecione a Cidade</option required>
                                                </select>
                                            </div>
