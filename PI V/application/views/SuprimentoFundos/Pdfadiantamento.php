...
<span  style="font-family:arial; text-align:center"> <h2><u> PROPOSTA DE CONCESSÃO DE ADIANTAMENTO DE VALORES</u> </h2><br>Fundamento Legal: Lei n° 4.320/64 – Lei Municipal n° 1.051/94</span><br>
...
<table cellspacing="0" cellpadding="1" style="font-family:arial; font-size:13px; border: 1px solid #000000;" border='1'>
    ...
    <tr colspan="4">
        <td class='col-xs-6'> Matrícula: $matricula</td>  
        <td></td>
...
<table cellspacing="0" cellpadding="1" style="font-family:arial; font-size:13px; border: 1px solid #000000;" border='1'>
    <tr class='thead-dark'>
        <td class='col-xs-6' colspan="4"><h4> 2. VALOR / MOTIVO</h4></td>
        <th></th>
    </tr>
    <tr colspan="4">
...
<table cellspacing="0" cellpadding="1" style="font-family:arial; font-size:13px; border: 1px solid #000000;" border='1'>
    ...
    <tr colspan="4">
        <td class='col-xs-6' colspan="4"><br> Órgão: $orgao - $fundo</td>       
    </tr>   
    <tr colspan="5">
        <td class='col-xs-6' colspan="4"> Atividade: $atividade</td> 
    </tr>
    <tr colspan="4">
        <td class='col-xs-6' colspan="4"> Elemento de Despesa: 3.3.0.9.6 Adiantamento de valores </td>
    </tr>
</table>
EOD;
